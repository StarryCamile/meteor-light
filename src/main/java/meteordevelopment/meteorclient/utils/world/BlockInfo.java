...
public class BlockInfo {
    ...
    public static BlockState getBlockState(BlockPos block) {return mc.world.getBlockState(block);}
    ...
    public static boolean isReplaceable(BlockPos block) {return mc.world.getBlockState(block).isReplaceable();}
    public static boolean isSolid(BlockPos block) {return mc.world.getBlockState(block).isSolidBlock(mc.world,block);}
